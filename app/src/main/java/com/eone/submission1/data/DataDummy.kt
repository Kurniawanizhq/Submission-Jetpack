...
object DataDummy {
    ...
    fun getTvShows(): ArrayList<DataEntity> {
        return arrayListOf(
            DataEntity(
                "tv1",
                "Arrow",
